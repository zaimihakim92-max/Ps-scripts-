...
.DESCRIPTION
    Source des adresses : un fichier .txt ET/OU une saisie directe (zone a coller).
    Les deux sources sont fusionnees et dedoublonnees. Pour chaque adresse, recherche
    du compte dans Entra ID (attribut mail, UserPrincipalName, adresses secondaires).
    Les comptes non trouves sont clairement identifies.

    Domaines alternatifs (optionnel) : si une adresse reste introuvable, sa partie locale
    est reforgee avec chaque domaine saisi puis re-recherchee. Aucun domaine n'est
    predefini : le champ est vide par defaut.

    - Recherche auto des domaines alternatifs pendant le traitement (case a cocher).
    - Bouton "Resoudre les non trouves" pour retenter apres coup.
...
function Get-InputEmails {
    # Fusionne fichier + saisie directe, dedoublonne. Tolere virgules/points-virgules/espaces.
    $raw = @()
    if (-not [string]::IsNullOrWhiteSpace($txtInput.Text) -and (Test-Path -LiteralPath $txtInput.Text)) {
        $raw += Get-Content -LiteralPath $txtInput.Text -ErrorAction SilentlyContinue
    }
    if (-not [string]::IsNullOrWhiteSpace($txtPaste.Text)) {
        $raw += $txtPaste.Text
    }
    if ($raw.Count -eq 0) { return @() }
    $blob = ($raw -join "`n")
    return @($blob -split '[,;\s]+' | ForEach-Object { $_.Trim() } |
...
$lblPaste.Text = "Ou coller ici :"; $lblPaste.Location = New-Object System.Drawing.Point(15, 48); $lblPaste.AutoSize = $true
$form.Controls.Add($lblPaste)

$txtPaste = New-Object System.Windows.Forms.TextBox
$txtPaste.Location = New-Object System.Drawing.Point(150, 45); $txtPaste.Size = New-Object System.Drawing.Size(740, 70)
$txtPaste.Multiline = $true; $txtPaste.ScrollBars = "Vertical"; $txtPaste.WordWrap = $false
$txtPaste.Anchor = "Top,Left,Right"
$form.Controls.Add($txtPaste)

$lblPasteHint = New-Object System.Windows.Forms.Label
$lblPasteHint.Text = "Une adresse par ligne (ou separees par virgule). Combinees avec le fichier si les deux sont renseignes."
$lblPasteHint.Location = New-Object System.Drawing.Point(150, 118); $lblPasteHint.AutoSize = $true; $lblPasteHint.ForeColor = [System.Drawing.Color]::Gray
$form.Controls.Add($lblPasteHint)

# --- Fichier export ---
$lblOutput = New-Object System.Windows.Forms.Label
$lblOutput.Text = "Export CSV :"; $lblOutput.Location = New-Object System.Drawing.Point(15, 143); $lblOutput.AutoSize = $true
$form.Controls.Add($lblOutput)

$txtOutput = New-Object System.Windows.Forms.TextBox
$txtOutput.Location = New-Object System.Drawing.Point(150, 140); $txtOutput.Size = New-Object System.Drawing.Size(625, 23)
...
$btnOutput.Text = "Parcourir..."; $btnOutput.Location = New-Object System.Drawing.Point(785, 139); $btnOutput.Size = New-Object System.Drawing.Size(105, 25)
$btnOutput.Anchor = "Top,Right"
$form.Controls.Add($btnOutput)

# --- Domaines alternatifs ---
$lblAlt = New-Object System.Windows.Forms.Label
$lblAlt.Text = "Domaines alt. :"; $lblAlt.Location = New-Object System.Drawing.Point(15, 176); $lblAlt.AutoSize = $true
$form.Controls.Add($lblAlt)

$txtAlt = New-Object System.Windows.Forms.TextBox
$txtAlt.Location = New-Object System.Drawing.Point(150, 173); $txtAlt.Size = New-Object System.Drawing.Size(740, 23)
$txtAlt.Anchor = "Top,Left,Right"
$form.Controls.Add($txtAlt)

$lblAltHint = New-Object System.Windows.Forms.Label
$lblAltHint.Text = "Optionnel. Un ou plusieurs domaines separes par une virgule, pour reforger les adresses non trouvees."
$lblAltHint.Location = New-Object System.Drawing.Point(150, 198); $lblAltHint.AutoSize = $true; $lblAltHint.ForeColor = [System.Drawing.Color]::Gray
...
$chkAutoAlt.Location = New-Object System.Drawing.Point(150, 221); $chkAutoAlt.AutoSize = $true; $chkAutoAlt.Checked = $true
$form.Controls.Add($chkAutoAlt)

# --- Statut Azure + connexion ---
$lblAz = New-Object System.Windows.Forms.Label
$lblAz.Location = New-Object System.Drawing.Point(15, 251); $lblAz.Size = New-Object System.Drawing.Size(600, 20)
$lblAz.Anchor = "Top,Left,Right"; $lblAz.Text = "Etat Azure : verification..."
$form.Controls.Add($lblAz)

$btnConnect = New-Object System.Windows.Forms.Button
$btnConnect.Text = "Connexion Azure"; $btnConnect.Location = New-Object System.Drawing.Point(765, 247); $btnConnect.Size = New-Object System.Drawing.Size(125, 25)
$btnConnect.Anchor = "Top,Right"
$form.Controls.Add($btnConnect)

# --- Lancer + progression ---
$btnRun = New-Object System.Windows.Forms.Button
$btnRun.Text = "Lancer le traitement"; $btnRun.Location = New-Object System.Drawing.Point(15, 283); $btnRun.Size = New-Object System.Drawing.Size(250, 30)
...
$progress.Location = New-Object System.Drawing.Point(280, 287); $progress.Size = New-Object System.Drawing.Size(610, 22)
$progress.Anchor = "Top,Left,Right"
$form.Controls.Add($progress)

# --- Grille ---
$grid = New-Object System.Windows.Forms.DataGridView
$grid.Location = New-Object System.Drawing.Point(15, 324); $grid.Size = New-Object System.Drawing.Size(875, 356)
...
$grid.Columns["ObjectId"].Visible = $false
$grid.Columns["Detail"].FillWeight = 18
$form.Controls.Add($grid)

# --- Recap + actions ---
$lblSummary = New-Object System.Windows.Forms.Label
$lblSummary.Location = New-Object System.Drawing.Point(15, 692); $lblSummary.Size = New-Object System.Drawing.Size(500, 40)
...
$btnResolve.Text = "Resoudre les non trouves"; $btnResolve.Location = New-Object System.Drawing.Point(555, 692); $btnResolve.Size = New-Object System.Drawing.Size(180, 30)
$btnResolve.Anchor = "Bottom,Right"; $btnResolve.Enabled = $false
$form.Controls.Add($btnResolve)

$btnExport = New-Object System.Windows.Forms.Button
$btnExport.Text = "Exporter en CSV"; $btnExport.Location = New-Object System.Drawing.Point(745, 692); $btnExport.Size = New-Object System.Drawing.Size(145, 30)
...
$btnConnect.Add_Click({
    ...
    catch { [System.Windows.Forms.MessageBox]::Show("Echec de la connexion :`n$($_.Exception.Message)", "Connexion Azure", "OK", "Warning") | Out-Null }
...
$grid.Add_CellDoubleClick({
    ...
    if ($upn) { [System.Windows.Forms.Clipboard]::SetText([string]$upn); $lblSummary.Text = "UPN copie : $upn" }
})
...
$btnRun.Add_Click({
    ...
    $emails = Get-InputEmails
    if ($emails.Count -eq 0) {
        [System.Windows.Forms.MessageBox]::Show("Aucune adresse a traiter.`nRenseignez un fichier .txt valide et/ou collez des adresses.", "Source vide", "OK", "Warning") | Out-Null; return
    }
    ...
    foreach ($email in $emails) {
        ...
        } catch { $statut = "ERREUR"; $detail = $_.Exception.Message }
